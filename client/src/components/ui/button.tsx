...
const buttonVariants = cva(
  "inline-flex items-center cursor-pointer justify-center gap-2 whitespace-nowrap text-sm font-medium transition-all disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg:not([class*='size-'])]:size-4 shrink-0 [&_svg]:shrink-0 outline-none focus-visible:border-ring focus-visible:ring-ring/50 focus-visible:ring-[3px] aria-invalid:ring-destructive/20 dark:aria-invalid:ring-destructive/40 aria-invalid:border-destructive",
  {
    variants: {
      variant: {
        default:
          "bg-accent text-foreground rounded-sm active:bg-destructive py-2 cursor-pointer",
        ...
        destructive:
          "bg-destructive text-white hover:bg-destructive/80 cursor-pointer focus-visible:ring-destructive/20 dark:focus-visible:ring-destructive/40 ",
        outline:
        ...
        secondary:
          "bg-red-400 rounded-sm hover:bg-red-500/80 text-secondary-foreground cursor-pointer ",
        ghost:
          "hover:bg-accent hover:text-accent-foreground cursor-pointer dark:hover:bg-accent/50",
        link: "text-primary hover:underline hover:text-chart-4",
      },
      size: {
