...
export default function BigBanner({ image, bannerStatus, title }: BannerTypes) {
  return (
    <div className="mx-auto relative overflow-hidden group  rounded-sm shadow-xl md:flex md:items-center">
      <img
        className="rounded-sm group-hover:scale-115 duration-800 delay-150"
        src={image}
        alt={title}
      />
      {/* Content Section (Left) */}
      <div className="absolute pl-15">
