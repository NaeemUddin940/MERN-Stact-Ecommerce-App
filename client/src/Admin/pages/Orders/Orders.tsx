...
export default function RecentOrders() {
  ...
  return (
    <div className="p-5 flex items-center justify-center">
      <div className="w-[1230px] border-2 rounded-sm shadow-lg border-accent p-5">
        <h2 className="text-2xl font-bold mb-4">All Orders Orders</h2>
                        ...
                        <div className="bg-muted/30 p-4">
                          ...
                          <div className="overflow-x-auto">
                            <div className="inline-block min-w-full">
                              <Table className="min-w-[700px] border border-border">
                                <TableHeader>
                                  <TableRow>
